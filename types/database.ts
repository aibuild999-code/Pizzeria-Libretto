...
export type Database = {
  public: {
    Tables: {
      ...
      restaurant_settings: Table<{restaurant_id:string;pickup_enabled:boolean;delivery_enabled:boolean;dine_in_enabled:boolean;scheduled_orders_enabled:boolean;large_order_approval_threshold:number|string;reservations_enabled:boolean;reservations_auto_confirm:boolean;reservations_max_auto_party_size:number;reservation_capacity:number|null;delivery_enabled_config:boolean;delivery_radius_km:number|string|null;delivery_minimum_order:number|string;free_delivery_threshold:number|string|null;delivery_distance_pricing:Json;notifications_enabled:boolean;notification_sound_enabled:boolean;notification_types:Json;ai_enabled:boolean;ai_escalation_settings:Json;ai_approval_rules:Json;ai_instructions:string|null;created_at:string;updated_at:string}>;
      ...
      customers: Table<{id:string;restaurant_id:string;name:string;first_name:string|null;last_name:string|null;phone:string;email:string|null;default_address_line1:string|null;default_address_line2:string|null;default_city:string|null;default_province:string|null;default_postal_code:string|null;delivery_instructions:string|null;created_at:string;updated_at:string}>;
      orders: Table<{id:string;order_number:number;restaurant_id:string;location_id:string;customer_id:string|null;customer_name:string;customer_phone:string;customer_email:string|null;fulfillment_type:string;status:string;approval_required:boolean;approval_reason:string|null;approved_at:string|null;rejected_at:string|null;notes:string|null;subtotal:number|string;tax:number|string;total:number|string;requested_at:string;confirmed_at:string|null;completed_at:string|null;scheduled_for:string|null;delivery_fee:number|string;delivery_address_line1:string|null;delivery_address_line2:string|null;delivery_city:string|null;delivery_province:string|null;delivery_postal_code:string|null;delivery_instructions:string|null;table_number:string|null;created_at:string;updated_at:string}>;
