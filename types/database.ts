...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      cancel_ai_order: {Args:{p_agent_id:string;p_restaurant_id:string;p_location_id:string;p_order_id:string;p_customer_phone:string;p_reason:string|null};Returns:Json};
